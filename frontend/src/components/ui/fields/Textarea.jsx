const Textarea = ({ label, error, helperText, className = '', ...props }) => (
  <label className="space-y-2 text-sm text-slate-700">
    ...
    <textarea
      className={`min-h-[120px] w-full rounded-2xl border px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-secondary focus:ring-2 focus:ring-secondary/20 ${
